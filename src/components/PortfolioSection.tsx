...
const projects: Project[] = [
  ...
  },
  {
    ...
    kind: "concept",
    industry: "Arkitektur & inredning",
    objective:
      "Ett stramt skandinaviskt rutnät där projekten får tala själva. Typografin håller sig tillbaka så att arbetet står i centrum.",
    capabilities: ["Projektgalleri", "Rutnätsbaserad layout", "Återhållsam typografi"],
    tags: ["Webbdesign", "Branding"],
